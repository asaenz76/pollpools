...
import { BracketForm } from "@/components/creator/forms";
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Single-elimination. Pick the competitors and we build the rounds.</p>
      </header>
      {ws.competitors.length < 2 ? (
        ...
        <BracketForm creatorId={ws.creator.id} tenantSlug={ctx.tenant.slug} competitors={ws.competitors} />
      )}
    </div>
  );
}
