...
// Labels for the generic competition formats now live in the tenant vocabulary
// (src/lib/vocabulary → competitionTypeLabel), so a tenant can re-label
// Event/Season/Tournament/Bracket without touching call sites.
